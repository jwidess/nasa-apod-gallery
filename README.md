...
**NEW!** - This project now uses the phenomenal [ellanan/apod-api](https://apod.ellanan.com/api) for faster requests, more reliable responses, built-in caching, and no API key required! Thanks to ellanan for providing this fantastic service. You can read more about the API and its features here: [How I Built a Faster and More Reliable APOD API](https://www.freecodecamp.org/news/building-a-faster-and-more-reliable-apod-api/)
